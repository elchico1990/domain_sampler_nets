...
def train(expDir = 'path/to/exp'):
	
	with open(expDir+'/results.pkl','r') as f:
		_,_,_,fX,fY = cPickle.load(f)
	...
	G_sample = generator(Z, y, G_W1, G_b1, G_W2, G_b2)
	D_real, D_logit_real = discriminator(X, y, D_W1, D_b1, D_W2, D_b2)
	D_fake, D_logit_fake = discriminator(G_sample, y, D_W1, D_b1, D_W2, D_b2)
