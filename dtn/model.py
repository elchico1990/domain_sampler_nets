...
class DSN(object):
    ...
    def build_model(self):
	    ...
	    self.EG_trg = self.E(self.G(self.fzy ,self.src_labels, reuse=True), reuse=True)  
	    ...
	    # Optimizers
            ...
            with tf.variable_scope('training_op',reuse=False):
                ...
                self.const_train_op_2 = slim.learning.create_train_op(self.const_loss_2, self.const_optimizer_2, variables_to_train=G_vars)
